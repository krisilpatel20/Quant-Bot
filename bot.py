...
if __name__ == "__main__":
    ...
    load_state()
    _load_update_offset()
    print("🚀 Pinehurst Main Kalman Render Engine Active — Exact Streamlit Status / Scheduled 15m")
    ...
    send_telegram(
        f"🚀 <b>Pinehurst Main Kalman Render Engine Active — Exact Streamlit Status / Scheduled 15m</b>\n"
